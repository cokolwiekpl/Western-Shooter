...
public class GetShot : MonoBehaviour
{
        ...
        if (Input.touchCount > 0 || Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                if (hit.transform == gameObject.transform)
                {
                    ...
                    //play some particle effect on point of impact
                    try
                    {
                    ...
                    //debug
                    Debug.Log("You just shot " + transform.name + " and scored " + points + " points!");
    ...
    public virtual void BreakObject()
    {
        ...
        try
        {
            if (transform.parent.parent.parent.parent.parent.parent.parent.gameObject.tag == "Dead")
            {
